...
$query = mysql_query("SELECT * FROM table_like_history WHERE link = '".$linkID."'order by year desc,month desc");

$table = array();
$table['cols'] = array(
    array('label' => 'date', 'type' => 'string'),
	array('label' => 'like', 'type' => 'number')
);
...
while($r = mysql_fetch_assoc($query)) {
	...
	$temp[] = array('v' => (int) $r['like_count']); // typecast all numbers to the appropriate type (int or float) as needed - otherwise they are input as strings
